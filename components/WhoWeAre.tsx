  ...
  return (
    <section className="relative w-full bg-black text-white py-16 px-6 md:py-24 font-sans overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
        ...
        {/* 2. Header Section - Fixed unclosed tags here */}
          ...
          {team.map((member, index) => (
            <motion.div 
              ...
              className={`
                ...
                /* This targets 1st (index 0), 3rd (index 2), and 5th (index 4) items */
                ${(index === 0 || index === 2 || index === 4) ? "md:mt-[20px]" : "md:mt-0"}
              `}
            >
              {/* Image Container */}
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="text-center max-w-4xl px-4 space-y-8"
        >
          <p className="text-base md:text-xl md:leading-relaxed text-zinc-300">
